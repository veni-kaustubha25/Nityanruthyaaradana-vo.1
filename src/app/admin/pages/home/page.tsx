        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-4">
                <FallbackImage src={content.heroImageUrl} alt="Hero background" width={200} height={100} className="rounded-md object-cover"/>
                <Button variant="outline" asChild>
                    <label htmlFor="hero-image-upload">
                        <Upload className="mr-2 h-4 w-4"/> Change Image
                        <input type="file" id="hero-image-upload" className="hidden" onChange={handleImageUpload} />
                    </label>
                </Button>
            </div>
          </div>
